...
#define CALLSIGN "DF1OE -10"     // enter your callsign here - less then 6 letter callsigns please add "spaces" so total length is 6 (without SSID)
#define WX_CALLSIGN "DF1OE -11"  // use same callsign but you can use different SSID
#define LONGITUDE_PRESET "00944.73E" // please in APRS notation DDDMM.mmE or DDDMM.mmW
#define LATIDUDE_PRESET "5223.42N"   // please in APRS notation DDMM.mmN or DDMM.mmS
...
#define HW_COMMENT              // send Alt und Battery Voltage, comment if don't want to send it
#define MY_COMMENT "LoRa-APRS DF1OE/m 433.775 MHz" // add your comment here - if empty then no comment is sent
#define MY_COMMENT2 " - TTGO by OE3CJB" // add your coment here - if empty then no comment is sent
